...
export const PersonalInfoForm = () => {
    // Added w-full and ! important flags to force the padding and layout
    const inputStyles = "w-full pl-12! py-6! bg-custom-2 border-transparent shadow-none focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-[#4F8F87] focus-visible:border-[#4F8F87] focus-visible:ring-offset-0 transition-colors"
            ...
            <form className="py-2!">
                <div className="max-w-3xl mx-auto grid grid-cols-1 md:grid-cols-2 mt-10! md:mt-20 gap-x-4 md:gap-x-8 gap-y-4 md:gap-y-2">
                    ...
                    <div className="flex flex-col gap-2">
                        ...
                        {/* Wrapped Select in the same relative div as the inputs for perfect alignment */}
                        <div className="relative">
